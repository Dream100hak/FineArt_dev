  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <button
        ...
        disabled={deleting}
        className="rounded-full border border-red-200 px-4 py-1 font-semibold text-red-600 transition hover:border-red-400 hover:text-red-700 disabled:cursor-not-allowed disabled:opacity-70"
      >
        {deleting ? '삭제 중...' : '글 삭제'}
      </button>
    </div>
